...
<body>
    ...
    <div class="content">
        <div class="container">
            <h1 class="mb-3">Element List</h1>

            <form action="{{ route('element.index') }}" method="GET" class="search-form">
            ...
            <a href="{{ route('element.index') }}" class="btn btn-dark mb-1">
                <i class="fas fa-times"></i>
            </a>
            <a href="{{ route('element.create') }}" class="btn btn-primary float-right mb-3">Create Element</a>
            ...
            {{ $elements->appends(['query' => $query])->links() }}
        </div>
    </div>
