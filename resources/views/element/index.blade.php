            ...
            <table class="table table-striped table-bordered" data-filterable>
                <thead class="thead-dark">
                    ...
                    <tr class="filter-row" style="background:#f8f9fa;">
                        ...
                        <td><input name="f[materials]" value="{{ $f['materials'] ?? '' }}" type="text" placeholder="Materials" style="width:100%;border:1px solid #dee2e6;border-radius:4px;padding:2px 4px;font-size:11px;"></td>
                        <td></td>
                    </tr>
                </thead>
                <tbody>
